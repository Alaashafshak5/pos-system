...
public class PersistentStorage {
    ...
    private String enterLineItemString = "INSERT INTO `pos`.`salelineitem` (`Product_idProduct`, `Sale_idSale`, `quantity`, `TotalPrice`) VALUES (?,?,?,?);";
    private String makeNewSaleString = "INSERT INTO `pos`.`sale` (`isCompleted`,`Date`) VALUES (?,?);";
    private String makePaymentString = "INSERT INTO `pos`.`payment` (`Date`, `Amount`, `isPaid`, `Sale_idSale`) VALUES (?,?,?,?);";
    ...
    public void makeNewSale() throws SQLException{
        ...
        makeNewSaleStmt.setBoolean(1, true);
